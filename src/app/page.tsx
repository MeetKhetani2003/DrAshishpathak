      ...
      <div className="grid lg:grid-cols-[1.5fr_1fr]">
        ...
        <div className="relative bg-navy px-5 py-16 text-white sm:px-10 lg:px-14 lg:py-20 xl:px-16">
          ...
          <div className="relative lg:sticky lg:top-28">
            ...
            {founder.memberships && (
              <>
                <p className="mt-10 eyebrow text-white/40">Memberships</p>
                <ul className="mt-4 space-y-2.5">
                  {founder.memberships.map((m) => (
                    <li key={m} className="flex gap-2.5 text-[0.82rem] leading-relaxed text-white/65">
      ...
      <div className="container-x">
        ...
        <ul className="mt-14 grid border-t border-navy/12 lg:grid-cols-5 lg:border-t-0">
          {whoWeServe.map((w, i) => (
            ...
            >
              <Link href={w.to} className="flex h-full flex-col px-0 py-8 lg:px-7 lg:py-10">
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-3 md:gap-px md:bg-navy/12">
          {insights.slice(0, 3).map((a, i) => (
            <Reveal key={a.slug} delay={i * 110}>
              <Link href={`/insights/${a.slug}`} className="group flex h-full flex-col bg-paper pt-px transition-colors duration-500 md:bg-white md:p-8 md:hover:bg-white">
