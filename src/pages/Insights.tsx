        ...
        <section className="bg-white py-16 lg:py-24">
          <div className="container-x grid gap-14 lg:grid-cols-[1fr_20rem] lg:gap-20">
            <div className="max-w-[46rem]">
              <Link to="/insights" className="group inline-flex items-center gap-2.5 text-[0.66rem] font-600 uppercase tracking-[0.2em] text-navy/60 transition-colors hover:text-navy">
              ...
              <p className="mt-12 bg-paper px-7 py-6 text-[0.84rem] leading-relaxed text-ink/60">
                ...
                rules before being relied upon. See the <Link to="/disclaimer" className="font-600 text-navy underline decoration-gold underline-offset-4">disclaimer</Link>.
              </p>
            </div>
